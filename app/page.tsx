...
// importamos la fuente que vamos a usar desde nuestro archivo de fuentes
import { lusitana } from '@/app/ui/fonts';
// importamos image de next/image para gestionar las imagenes
    ...
    <main className="flex min-h-screen flex-col p-6">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          ...
          {/* de esta forma interpolamos para traer el className que necesitamos y de esa forma aplicar la fuente a este elemento */}
